...
if __name__ == '__main__':
    ...
    name = "Nishant Dash"
    division = "A1 Sparing"
    command = f'ffmpeg -vsync 2 -i {video_path} {make_text_intro_video("30000/1001")} -filter_complex "{make_text_intro_filter(name, division)};{cuts};{cross_fade("introvid", "2", "outvtb", "outa", "final", 2)}" -map [finalv] -map [finala] -y -avoid_negative_ts make_zero out.mp4'
    print(command)
    subprocess.call(command, shell=True)
